...
#   python check_docker_config.py <docker_info_file> <whitelist_file>
# - Where <docker_info_file> is the output of 'docker info' saved to a text file,
